...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Start Camera, Action!';
            ...
            FB.login(function (response) {
                ...
                if (response.authResponse) {
                    ...
                    FB.api('/me', { fields: 'id,name,email,picture' }, function (response) {
                        ...
                        var bikeImage = document.getElementById("image-holder");
...
module.exports = __webpack_require__(/*! /home/samayuadmin/Projects/scaction/web/scaction/src/main.ts */"./src/main.ts");
