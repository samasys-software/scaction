...
/* harmony import */ var _profile_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./profile.component */ "./src/app/profile.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _popup_component__WEBPACK_IMPORTED_MODULE_4__["PopUpComponent"]
            ],
            imports: [
...
var PopUpComponent = /** @class */ (function () {
    ...
    PopUpComponent.prototype.open = function (content) {
        var _this = this;
    ...
    PopUpComponent.prototype.getDismissReason = function (reason) {
    ...
    PopUpComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-popup',
            template: __webpack_require__(/*! ./popup.component.html */ "./src/app/popup.component.html")
        }),
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.onLoginClick = function () {
        ...
        this.http.get('http://localhost:8082/user/checkUser/samayu1').subscribe(function (res) {
            ...
            _this.user = res;
            _this.imageUrl = res['profilePic'];
            _this.fbUser = res['fbUser'];
        });
